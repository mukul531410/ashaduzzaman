...
<head>
     ...
     <title>Ashaduzzaman Mukul Resume</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="mt-lg-0 mt-3 mb-4 mb-lg-0">
                    <a href="images/ashaduzzaman-resume.pdf" class="custom-btn btn" download>Download CV</a>
                </div>
            </div>
         ...
         <div class="container">
            <div class="row">
                  ...
                  <div class="mx-auto col-lg-5 col-md-5 col-10">
                      <img src="images/mukul-resume.jpg" class="img-fluid" alt="Mukul">
                  </div>

                   <div class="d-flex flex-column justify-content-center align-items-center col-lg-7 col-md-7 col-12">
                        <div class="hero-text">

                            <h1 class="hero-title">👋 Mukul, a digital nomad</h1>

                            <a href="mailto:mukul.ashad@gmail.com" class="email-link">mukul.ashad@gmail.com</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <h3 class="mb-4">This is Ashaduzzaman's Resume</h3>

                    <p>Passionate WordPress Developer with 7+ years of working experience. I'm an expert in the front-end and WordPress back-end. I can build custom themes from the sketch, develop WordPress theme, customize any WordPress themes or plugin, optimization websites, bug fixing. My core competency lies in clean, semantic, and SEO friendly coding with 100% W3C validation</p>

                    <ul class="mt-4 mb-5 mb-lg-0 profile-list list-unstyled">
                        <li><strong>Full Name :</strong> Ashaduzzaman (Mukul) </li>

                        <li><strong>Date of Birth:</strong> 25 December 1990</li>

                        <li><strong>Website :</strong> https://mukul531410.github.io/ashaduzzaman/</li>

                        <li><strong>Email :</strong> mukul.ashad@gmail.com</li>
                    </ul>
                </div>
                        ...
                        <div class="owl-carousel owl-theme" id="testimonials-carousel">
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="images/testimonials/evan.jpg" class="img-fluid" alt="testimonials image">
                                    </div>

                                    <div class="testimonials-info">
                                        <p>This freelancer continues to excel at the tasks that I ask of them. They are quick, helpful, and communicative. They pay attention to the small details and help me to make my requests pixel perfect across devices. What's more is that they are knowledgeable, fluent in my language, and make sure that they complete the tasks that I need each and every time. I will continue using them when I have development tasks that are out of my wheelhouse. I can't recommend them enough!</p>

                                        <h6 class="mb-0">Evan Hall</h6>
                                        <span>Founder, Pexl Design</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    ...
                                    <div class="testimonials-info">
                                        <p>The man is truly a master at his craft. We had a PHP task no-one would touch.. he nailed it like he was drinking a 'Smoothie' and asked for more.</p>
                                        <p>Full marks.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-12">
                    ...
                    <span class="faq-info-text">Please send us a message if you have anything to say. Send an email message to <strong>mukul.ashad@gmail.com</strong></span>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-12">
            ...
            <div class="mx-auto col-lg-4 col-md-6 col-12">
                ...
                <p class="mb-1">+8801724639919</p>

                <p>
                    <a href="mailto:mukul.ashad@gmail.com">mukul.ashad@gmail.com
                    <i class="fas fa-arrow-right custom-icon"></i>
                    </a>
                </p>

                <ul class="social-links mt-2">
                    <li><a href="https://www.facebook.com/mukul.ashad" rel="noopener" class="fab fa-facebook"></a></li>
                    <li><a href="https://x.com/mukul531410" rel="noopener" class="fab fa-twitter"></a></li>
                    <li><a href="https://www.instagram.com/mukul531410/" rel="noopener" class="fab fa-instagram"></a></li>
                    <li><a href="https://www.linkedin.com/in/ashaduzzaman-6b646b21/" rel="noopener" class="fab fa-linkedin"></a></li>
                    <!-- <li><a href="#" rel="noopener" class="fab fa-youtube"></a></li> -->
                </ul>
                
              <p class="copyright-text mt-5 pt-3">Copyright &copy; <?php echo date('Y'); ?> Ashaduzzaman</p>
            </div>
